...
(function(){
  ...
  function init(){
    ...
    style.textContent = [
      ...
      '#sw-btn svg{flex:none;opacity:.85;}',
      '#sw-menu{display:none;position:absolute;left:0;bottom:calc(100% + 8px);min-width:212px;',
      ...
      '#sw-root.open #sw-menu{display:block;}',
      '#sw-menu a{display:flex;align-items:center;justify-content:space-between;gap:14px;',
        ...
        'color:#E9EBF0;transition:background .15s;}',
